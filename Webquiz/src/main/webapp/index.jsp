    ...
    <div class="middle_main">
        ...
        <div class="card">
            <img class="card-img-top" src="../static/img/500-mau-cau-tieng-anh-giao-tiep-hay-dung-nhat-phan-1.png"
                 style="height: 160px" alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card">
            <img class="card-img-top" src="../static/img/quy-dinh-thi-bang-lai-xe-may.png" style="height: 165px"
                 alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card">
            <img class="card-img-top" src="../static/img/post-thumb-ngon-ngu-lap-trinh.png" style="height: 165px"
                 alt="Card image cap">
            <div class="card-body">
