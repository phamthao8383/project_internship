        ...
        <div class="row">
            ...
            <div class="col-10 content">
                <div class="content__title">
                    <p class="content__title-label">Danh sách đề thi</p>
                    <div class="title-actions">
                        <button type="button" class="btn btn-outline-success btn-sm">Nhập câu đố</button>
                        <button type="button" class="btn btn-outline-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#createModal">Tạo mới</button>
                        <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal">Xóa đề</button>
                    </div>
                </div>
                <div class="user-list">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Xoá đề thi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Xác nhận xoá những đề thi đã chọn?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
